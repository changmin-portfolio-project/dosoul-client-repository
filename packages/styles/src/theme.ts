const mainColor = {
  ...
  DosoulOrange: "#f46b1f",
  DosoulYellow: "#fdde28",
  DosoulGradient: `linear-gradient(
    253deg,
    #ee2368 -5.93%,
    #f46b1f 57.63%,
    #fdde28 95.93%
...
const systemSize = {
  appDisplaySize: {
    ...
    sideBarNum: 400,
    mobileBottomSheetHeightNum: mobileBottomSheetHeightNum,
    menuSideBarWidthNum: MENU_SIDE_BAR_WIDTH,
    menuSideBarWidth: `${MENU_SIDE_BAR_WIDTH}px`,
    desktopMaxWidthNum: DESKTOP_MAX_WIDTH,
    desktopMaxWidth: `${DESKTOP_MAX_WIDTH}px`,
    bottomNavBarHeightNum: 66,
  },
  bottomNavBar: {
    heightNum: 55,
    height: "55px",
